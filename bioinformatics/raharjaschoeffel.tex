...
\hline
\texttt{$k_1$} & 120 & 100 & 104.489 & 105.533 & 104.497\\
\texttt{$k_2$} & 120 & 100 & 104.585 & 104.771 & 104.099\\
\texttt{$k_3$} & 0.4 & 0.3 & 0.356 & 0.351 & 0.344\\
\texttt{$k_4$} & 0.4 & 0.3 & 0.355 & 0.337 & 0.356\\
...
\begin{figure*}[h]
\includegraphics[width=0.75\textwidth]{figures/test_results.pdf}
...
\hline
\texttt{$k_1$} & 800 & 799.369 & 798.596 & 800.094\\
\texttt{$k_2$} & 400 & 398.35 & 401.315 & 400.126\\
\texttt{$k_3$} & 0.01 & 0.0129 & 0.0125 & 0.0128\\
\texttt{$k_4$} & 0.01 &  0.0185 & 0.0159 & 0.0223\\
...
\begin{figure}[h]
\includegraphics[width=0.75\textwidth]{figures/real_data.pdf}
...
\begin{equation}
B_{M1, M2} = \frac{P(\mathcal{D} | M_{inhibitory})}{P(\mathcal{D} | M_{indepent})} = \frac{2^{-2937.356}}{2^{-3640.912}} \approx 6.19 \cdot 10^{211} \label{eq:31}
\end{equation}
