	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
				...
				\item Inhibiton modeled trough inverse michaelis menten kinetik
				\item Parameterize production and degredation rates as well as inhibition half point
			\end{itemize}
		\end{column}
...
\begin{frame}{Model Comparison Test}
		\begin{columns}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
...
\begin{frame}{Single cell time lapse data}
	\begin{figure}[ht]
		\begin{center}
...
\begin{frame}{Conclustion \& Outlook}
	\begin{itemize}
